...
import { POSITION_A1, POSITION_C } from "../constants"

// Создание маршрута №3
const createThirdRoutineMachineLayer = () => {
  // Стартовые точки
  const instance = L.Routing.control({
    waypoints: [
      L.latLng(POSITION_A1[0], POSITION_A1[1]),
    ...
    lineOptions: {
      styles: [{ color: "lightgreen", weight: 4 }],
    },
    show: true,
...
export const LeafletThirdRoutingMachine = createControlComponent(
  createThirdRoutineMachineLayer
)
